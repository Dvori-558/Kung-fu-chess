...
public class Img {
    ...
    public void putText(String txt, int x, int y, float fontSize,
        ...
        g.setColor(color);
        g.setFont(new Font("SansSerif", Font.BOLD, (int)(fontSize * 12)));
    ...
    public void show() {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame f = new JFrame("Kung-fu Chess");
    ...
    public int getWidth() { return img != null ? img.getWidth() : 0; }
    public int getHeight() { return img != null ? img.getHeight() : 0; }
}